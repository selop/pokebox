...
const STYLE_UNIFORMS: Partial<Record<ShaderStyle, UniformMapping[]>> = {
  ...
  'master-ball': [
    ...
    ['uSparkleTexMix', 'masterBallSparkleTexMix'],
    ['uSparkle2Scale', 'masterBallSparkle2Scale'],
    ['uSparkle2Intensity', 'masterBallSparkle2Intensity'],
    ['uSparkle2TiltSensitivity', 'masterBallSparkle2TiltSensitivity'],
    ['uSparkle2TexMix', 'masterBallSparkle2TexMix'],
    ['uEtchOpacity', 'masterBallEtchOpacity'],
    ...
    ['uGlareSaturation', 'masterBallGlareSaturation'],
