...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  illustRareBarDensity: 1.7,
  illustRareBarOffsetBgXMult: -0.1,
  illustRareBarOffsetBgYMult: -0.4,
  illustRareBar2OffsetBgXMult: -1.1,
  illustRareBar2OffsetBgYMult: 0.4,
  illustRareBarWidth: 4.8,
  illustRareBarIntensity: 13.6,
  illustRareBarHue: 214.0,
  illustRareBarMediumSaturation: 0.54,
