...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  sirBarFrequency: 100.0,
  sirBarBrightness: 1.0,
  sirBarContrast: 1.7,
  sirBarSaturation: 0.75,
  sirSunpillarBrightness: 0.0,
  sirSunpillarContrast: 1.6,
  sirSunpillarSaturation: 1.65,
  sirGlitterContrast: 0.7,
  sirGlitterSaturation: 1.0,
  sirBaseBrightness: 0.75,
  sirBaseContrast: 1.45,
