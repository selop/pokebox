...
const sections: ShaderSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Bar offset X', key: 'illustRareBarOffsetBgXMult', min: -5, max: 5, step: 0.05 },
      { label: 'Bar offset Y', key: 'illustRareBarOffsetBgYMult', min: -5, max: 5, step: 0.05 },
      { label: 'Bar2 offset X', key: 'illustRareBar2OffsetBgXMult', min: -5, max: 5, step: 0.05 },
      { label: 'Bar2 offset Y', key: 'illustRareBar2OffsetBgYMult', min: -5, max: 5, step: 0.05 },
