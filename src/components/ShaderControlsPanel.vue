...
const sections: ShaderSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Bar width', key: 'illustRareBarWidth', min: 0.1, max: 10, step: 0.05 },
      { label: 'Bar intensity', key: 'illustRareBarIntensity', min: 0, max: 20, step: 0.05 },
      { label: 'Bar hue', key: 'illustRareBarHue', min: 0, max: 360, step: 1, suffix: '°' },
      {
        label: 'Bar med sat',
  ...
  },
  {
    ...
    items: [
      ...
      { subsection: 'Fine Bars' },
      { label: 'Frequency', key: 'sirBarFrequency', min: 5, max: 100, step: 1 },
      { label: 'Brightness', key: 'sirBarBrightness', min: 0, max: 3, step: 0.05 },
      { label: 'Contrast', key: 'sirBarContrast', min: 0, max: 3, step: 0.05 },
      { label: 'Saturation', key: 'sirBarSaturation', min: 0, max: 3, step: 0.05 },
      { subsection: 'Sunpillars' },
      { label: 'Brightness', key: 'sirSunpillarBrightness', min: 0, max: 5, step: 0.05 },
      { label: 'Contrast', key: 'sirSunpillarContrast', min: 0, max: 5, step: 0.05 },
      { label: 'Saturation', key: 'sirSunpillarSaturation', min: 0, max: 5, step: 0.05 },
      { subsection: 'Glitter' },
